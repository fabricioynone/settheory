...
\begin{proof}
    ...
    Como $(\rho\sigma)_{-z}$ e $\rho_{-z}\sigma_{-z}$ são extensões de $\tau$ por elementos que não ocorrem livres em $\psi$, segue do Metalema~\ref{mlem:substituicaoTrivialEmFormulas} que $\psi[(\rho\sigma)_{-z}]$ é válida.
...
\begin{proof}
    ...
    Como no item (a), $\rho\sigma$ é o mapeamento trivial de variáveis e constantes definido em $X$, de modo que $\varphi[\rho\sigma]$ é $\varphi$ pelo Metalema~\ref{mlem:substituicaoTrivial}.
    ...
    Pelo Metalema~\ref{mlem:substituicaoEmFormulas2}, como $\psi[\rho_0]$ é válida, temos que uma das duas possibilidades ocorre:
    \begin{itemize}
    ...
    Se $z\notin X$, então $\sigma(y)\in X$, e, portanto, $z\neq\sigma(y)$.
    Suponha então que $z\in X$ e, por absurdo, que $\sigma(y)=z$.
    Equivalentemente, $y=\rho(z)$.
    Pelo Metalema~\ref{mlem:substituicaoEmFormulas2}, aplicado à substituição válida $\psi[\rho_0]$, temos que uma das duas possibilidades ocorre:
    \begin{itemize}
        \item $y$ ocorre livre em $\psi$ e $y$ não está em $X_0$;
