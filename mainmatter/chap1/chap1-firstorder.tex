...
De forma geral, ao se referir a ``símbolos de predicado'', a igualdade é inclusa por convenção.
Se queremos excluir a igualdade do domínio de discurso, utilizaremos a terminologia de ``símbolos de predicado não lógicos''.
