...
\begin{definition}
    Seja $R$ uma relação definida e $A$ uma classe definida ou conjunto tal que $R_A$ é transitivo e bem-fundada.
    
    Para todo $x\in A$, definimos $\rank_{R, A}(x)=\rank_{R_A}(x)$.
\end{definition}
