...
\begin{definition}[$\ZFmP$]
    ...
    Um conjunto ou classe $X$ é \textit{bem fundada} se $\in$ é bem fundada em $\trcl(X)$.
...
\begin{corollary}[$\ZFmP$]
    Um conjunto ou classe $X$ é bem fundado se, e somente se, $\in$ é bem fundada em algum conjunto ou classe transitiva que contém $X$.
\end{corollary}
\begin{proof}
    Se $X$ é bem fundado, então $\in$ é bem fundada em $\trcl(X)$, que é transitiva e contém $X$.

    Já se $\in$ é bem fundada em algum conjunto ou classe transitiva $t$ que contém $X$, então $\in$ é bem fundada em $\trcl(X)$, pois $\trcl(X)\subseteq t$.
\end{proof}
